...
def main():
    ...
    sc.pl.dotplot(adata, receptors, 'Subclass', dendrogram=False, swap_axes=True, ax=ax,
                colorbar_title='mean z-score', layer='scaled', vmin=-2, vmax=2, cmap='RdYlBu_r', 
                return_fig=False, show=False, var_group_rotation=45, title = None, dot_max=.60)
    fig.tight_layout()
